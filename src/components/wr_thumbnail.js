    ...
    render(){
        ...
        return(
            <div className="pull-right">
                <div>
                      <Link to={`/runs/${this.props.run.id}`}><img src={this.thumbnailUrl(this.props.run)} role="presentation" height="120" width="200"  style={{marginBottom: "20px", marginRight: "80px", marginLeft:"80px"}}/></Link>
                </div>
            </div>
        )
    }
