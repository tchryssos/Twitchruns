...
export default function SelectedStream(props){
  ...
  if (props.runUrl.includes('youtube')){
    ...
    videoEmbed =  <iframe width="600" height="450" src={videoUrl} allowFullScreen></iframe>

  }else if(props.runUrl.includes('channel')) {
    videoEmbed =   <iframe width="600" height="450" src={props.runUrl} allowFullScreen></iframe>
    ...
    videoEmbed =   <iframe width="600" height="450" src={twitchUrl} allowFullScreen>
            </iframe>
  }
